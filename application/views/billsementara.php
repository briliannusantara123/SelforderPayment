...
<body>
    ...
    <div class="main-content">
        ...
        <?php foreach ($order_bill_line as $i): ?>
            <div class="row">
                <?php if ($i->is_paid == 1): ?>
                  <h6 style="background-color: <?= $cn->color ?>;padding-top: 5px;padding-bottom: 5px;color: white">Paid</h6>
                <?php else: ?>
                  <h6 style="background-color: red;padding-top: 5px;padding-bottom: 5px;color: white">Unpaid</h6>
                <?php endif ?>
