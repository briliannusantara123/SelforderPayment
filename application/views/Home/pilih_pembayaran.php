...
<div class="container text-center">
  <div class="row">
    ...
    <h2 style="color:#198754;margin-bottom: 10px; ">Select Payment</h2>
    <div class="col">
      <a class="" href="<?= base_url() ?>index.php/selforder/home/4/<?= $type?>/1" role="button"  style="text-decoration:none"><img src="<?= base_url();?>/assets/icon/menu/qrcode.png" style="width: 200px;height: 200px;border-radius: 5%;" alt="Hachi Grill" class="image" /><h2 style="color:#198754;margin-top: 5px; ">PAY HERE CASHLESS</h2></a>
    </div>
 
    <div class="col">
      <a class="" href="<?= base_url() ?>index.php/selforder/home/4/<?= $type?>/2" role="button"  style="margin-top: 20px;text-decoration:none"><img src="<?= base_url();?>/assets/icon/menu/cashier.png" style="width: 200px;height: 200px;border-radius: 5%;" alt="Hachi Grill" class="image" /><h2 style="color:#198754;margin-top: 5px; ">PAY AT COUNTER CASH & CASHLESS</h2></a>
    </div>
  </div>
