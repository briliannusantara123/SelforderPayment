...
<div class="container text-center">
  <div class="row">
    <div class="fadeIn first">
      <img src="<?= base_url();?>assets/logo.png" style="width: 400px;height: 150px;margin-bottom: 10px;" alt="Dear Clio" />
      <br>
      <a href="<?= base_url();?>index.php/selforder/type" class="btn btn-success">ORDER NOW</a>
    </div>
  </div>
