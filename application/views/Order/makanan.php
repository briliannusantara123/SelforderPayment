...
.ICE_CREAM{
   background-image: url("<?= base_url() ?>/assets/icon/ice_cream.png");
  background-repeat: no-repeat;
  background-size: 55%;
  background-position-y: 20%;
  background-position-x: 50%;
...
.WESTERN{
   background-image: url("<?= base_url() ?>/assets/icon/western.png");
  background-repeat: no-repeat;
  background-size: 60%;
  background-position-y: 20%;
  background-position-x: 50%;
...
<script type="text/javascript">
      $(document).ready(function(){
        ...
        var h = '<?= base_url() ?>index.php/ordermakanan/menumakanan/Makanan/<?= $subpertama->sub_category_so ?>';
        $('#konten').load(h);
        item<?= $subpertama->sub_category_so ?>.classList.add('active');
        var key = "<?= $key ?>";
        if (key != '') {
          $('#konten').load('<?= base_url() ?>index.php/ordermakanan/search/1');
        }
         if (window.location.toString() == "<?= base_url() ?>index.php/ordermakanan/menu/Makanan/<?= str_replace(" ","%20", $i['sub_category_so']) ?>#<?= str_replace(" ","_", $i['sub_category_so']) ?>") {
          $('#konten').load('<?= base_url() ?>index.php/ordermakanan/menumakanan/Makanan/<?= str_replace(" ","%20", $i['sub_category_so']) ?>#<?= str_replace(" ","_", $i['sub_category_so']) ?>');
         }else if (window.location.toString() == "<?= base_url() ?>index.php/ordermakanan/menu/Makanan/rekomendasi#rekomendasi") {
          $('#konten').load('<?= base_url() ?>index.php/ordermakanan/menumakanan/Makanan/rekomendasi#rekomendasi');
         }
    ...
    var h = '<?= base_url() ?>index.php/ordermakanan/menumakanan/Makanan/<?= str_replace(" ","%20", $i['sub_category_so']) ?>';

    // Load content into the specified element
    $('#konten').load(h);

    item<?= $subpertama->sub_category_so ?>.classList.remove('active');
    ...
    console.log(h);
        ...
        $('#rekomendasi').click(function(){
          // mengambil data dari href
          var h = '<?= base_url() ?>index.php/ordermakanan/menumakanan/Makanan/rekomendasi';
          // alert(h);
          $('#konten').load(h);
        ...
        $('#all').click(function(){
          // mengambil data dari href
          var h = '<?= base_url() ?>index.php/ordermakanan/menumakanan/Makanan/all';
          // alert(h);
          $('#konten').load(h);
          // konten akan diisi oleh menu yang dipilih sesuai dengan isi dari href yang dipilih
  ...
  $(document).ready(function(){
    ...
    search.addEventListener("input", function() {
      if (search.value) {
        ...
        h = '<?= base_url() ?>index.php/ordermakanan/menumakanan/Makanan/<?= $subpertama->sub_category_so ?>';
        $('#konten').load(h);
      }
