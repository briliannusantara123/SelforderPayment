...
if (localStorage.getItem('<?=$i->no?>')) {
  ...
  simpan<?= $i->id ?>.addEventListener("click", ()=>{
    ...
    setTimeout(function() {
            if (window.location.toString() == "<?= base_url() ?>index.php/orderminuman/menu/Minuman/Salad#Salad") {
      var h = '<?= base_url() ?>index.php/orderminuman/menuminuman/Minuman/Salad#Salad';
          // alert(h);
          $('#konten').load(h);
    }
    if (window.location.toString() == "<?= base_url() ?>index.php/orderminuman/menu/Minuman/Rice#Rice") {
          var h = '<?= base_url() ?>index.php/orderminuman/menuminuman/Minuman/Rice#Rice';
              // alert(h);
              $('#konten').load(h);
        }
    if (window.location.toString() == "<?= base_url() ?>index.php/orderminuman/menu/Minuman/Package#Package") {
      var h = '<?= base_url() ?>index.php/orderminuman/menuminuman/Minuman/Package#Package';
          // alert(h);
          $('#konten').load(h);
    }
    if (window.location.toString() == "<?= base_url() ?>index.php/orderminuman/menu/Minuman/Western#Western") {
      var h = '<?= base_url() ?>index.php/orderminuman/menuminuman/Minuman/Western#Western';
          // alert(h);
          $('#konten').load(h);
    }
        }, 500);
...
<script type="text/javascript">
      $(document).ready(function(){
        ...
        var h = '<?= base_url() ?>index.php/orderminuman/menuminuman/Minuman/<?= $subpertamaminum->sub_category_so ?>';
        $('#konten').load(h);
        item<?= $subpertamaminum->sub_category_so ?>.classList.add('active');
        var key = "<?= $key ?>";
        if (key != '') {
          $('#konten').load('<?= base_url() ?>index.php/orderminuman/search/1');
        }
         if (window.location.toString() == "<?= base_url() ?>index.php/orderminuman/menu/Minuman/<?= str_replace(" ","%20", $i['sub_category_so']) ?>#<?= str_replace(" ","_", $i['sub_category_so']) ?>") {
          $('#konten').load('<?= base_url() ?>index.php/orderminuman/menuminuman/Minuman/<?= str_replace(" ","%20", $i['sub_category_so']) ?>#<?= str_replace(" ","_", $i['sub_category_so']) ?>');
         }else if (window.location.toString() == "<?= base_url() ?>index.php/orderminuman/menu/Minuman/rekomendasi#rekomendasi") {
          $('#konten').load('<?= base_url() ?>index.php/orderminuman/menuminuman/Minuman/rekomendasi#rekomendasi');
         }
    ...
    var h = '<?= base_url() ?>index.php/orderminuman/menuminuman/Minuman/<?= str_replace(" ","%20", $i['sub_category_so']) ?>';

    // Load content into the specified element
    $('#konten').load(h);

    item<?= $subpertamaminum->sub_category_so ?>.classList.remove('active');
    ...
    console.log(h);
        ...
        $('#rekomendasi').click(function(){
          // mengambil data dari href
          var h = '<?= base_url() ?>index.php/orderminuman/menuminuman/Minuman/rekomendasi';
          // alert(h);
          $('#konten').load(h);
        ...
        $('#all').click(function(){
          // mengambil data dari href
          var h = '<?= base_url() ?>index.php/orderminuman/menuminuman/Minuman/all';
          // alert(h);
          $('#konten').load(h);
          // konten akan diisi oleh menu yang dipilih sesuai dengan isi dari href yang dipilih
  ...
  $(document).ready(function(){
    ...
    search.addEventListener("input", function() {
      if (search.value) {
        ...
        var h = '<?= base_url() ?>index.php/orderminuman/search/'+search.value;
        konten.style.display = "none";
        $('#kon').load(h);
      } else {
        kon.style.display = "none";
        konten.style.display = "block";
        h = '<?= base_url() ?>index.php/orderminuman/menuminuman/Minuman/<?= $subpertamaminum->sub_category_so ?>';
        $('#konten').load(h);
      }
